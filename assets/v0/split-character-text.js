(function(){
  ...
  // Split characters for one "host" (the hover/focus trigger)
  function splitChars(hostEl){
    ...
    const inc = parseFloat(hostEl.getAttribute('data-animate-delay') || '0.01'); // seconds per char
    ...
    // Touch “pulse” so mobile users see the effect (host is the trigger)
    const pulse = () => {
